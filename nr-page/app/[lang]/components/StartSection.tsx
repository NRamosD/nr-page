        ...
        <>
            <div className=' my-auto '>
              <div className={`transition-all duration-500 -space-y-10 ${myName?"translate-y-0 opacity-1":"translate-y-20 opacity-0"}`}>
                ...
                <h2 className='text-[20px] p-0 uppercase text-[#808a8f]'>{props.landing.profession}</h2>
              </div>
              <div className="">
                <h3 className='text-[60px] uppercase text-shadow-landing'>{`${props.landing.welcome.split("!")[0]}!`}</h3>
                <div className="flex">
              ...
              <p className={`text-shadow-landing transition-all duration-500 ${textToStart?"translate-y-0 opacity-1":"-translate-y-20 opacity-0"} text-[40px] uppercase`}>{`${props.landing.welcome.split("!")[1]}`}</p>
              <a href='#summary' className={`transition-all animate-bounce duration-500  ${startRead?"opacity-1":"opacity-0"} text-[40px] uppercase`}>{`${props.landing.start}`}<div className='animate-bounce text-black'>↓</div></a>
            </div>
