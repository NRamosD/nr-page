        ...
        <>
            <div className=' my-auto'>
              <div className={`transition-all duration-500 -space-y-10 ${myName?"translate-y-0 opacity-1":"translate-y-20 opacity-0"}`}>
                ...
                <h1 className='text-[100px] p-0 uppercase'>{props.landing.name}</h1>
                <h2 className='text-[20px] p-0 uppercase'>{props.landing.profession}</h2>
              </div>
              <div className="">
              ...
              <a href='#summary' className={`transition-all duration-500 underline ${startRead?"opacity-1":"opacity-0"} text-[40px] uppercase`}>{`${props.landing.start}`}↓</a>
            </div>
