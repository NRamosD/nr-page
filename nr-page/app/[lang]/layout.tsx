  ...
  return (
    <html lang="">
      ...
      <body className={`${font1.className}`}>
        ...
        {children}
        <footer className='gradient-bg h-[20vh] flex relative bg-gradient-to-r from-[#081a25] via-teal-600 to-sky-800'>
