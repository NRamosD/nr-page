  ...
  return (
    <html lang="">
      ...
      <body className={`${font1.className}`}>
        <header className='transition-all duration-1000 ease-out navbar w-fit grid  fixed bottom-0 left-0 shadow-2xl z-20 border-b-2 border-[#ffffff] hover:-translate-y-0 translate-y-28 hover:bg-black hover:border-t-2 hover:border-r-2 rounded-tr-md'>
        ...
        <footer className='gradient-bg h-[20vh] flex relative'>
          <div className='m-auto grid  text-white  '>
            ...
            <div>
              <div className="text-to-show grid text-5xl">
                <h3 className="text-center playwrite-cursive" >Connect with Me⚡</h3>
                {/* <span className="text-center p-5" ></span> */}
                {/* <h3 className="text-center" >By Nixon Ramos</h3> */}
              </div>
              <div className="m-auto grid grid-cols-3 gap-4 text-2xl my-5 playwrite-moderne">
                  <Link href={"mailto:nixonramosdue@gmail.com"} target='blank' 
                    className="flex m-auto hover:underline text-center text-yellow-400 transition-transform hover:scale-110 ease-out  duration-1000 ">
                    {/* <div className=' relative flex w-[80px] h-[80px] rounded-md  scale-icons-contact'> */}
                      <div className='' data-aos="fade-up" data-aos-duration="1000" data-aos-offset="0">
                        <svg viewBox="0 0 24 24" className='w-24 invert' fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 8L8.44992 11.6333C9.73295 12.4886 10.3745 12.9163 11.0678 13.0825C11.6806 13.2293 12.3194 13.2293 12.9322 13.0825C13.6255 12.9163 14.2671 12.4886 15.5501 11.6333L21 8M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
                      </div>
                      {/* <div className=' m-auto'>
                        nixonramosdue@gmail.com
                      </div> */}
          ...
          <div className="text-center absolute bottom-0 right-0 left-0 text-white ">
            <h4 className="text-center playwrite-cursive">©{new Date().getUTCFullYear()}</h4>
            <h4 className='playwrite-moderne'>nixr.dev</h4>
            <h4 className="text-center playwrite-moderne">All rights reserved.</h4>
          </div>
        </footer> 
